...
var notices_routes_1 = require("../routes/notices.routes");
...
var Server = /** @class */ (function () {
    ...
    Server.prototype.dbConnecion = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.dbConnecion()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Server.prototype.listen = function () {
        ...
        this.app.listen(this.port, function () {
            console.log("CORRIENDO en https://localhost:" + _this.port);
        });
    };
    return Server;
}());
