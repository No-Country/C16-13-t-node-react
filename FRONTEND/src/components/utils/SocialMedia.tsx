...
export const SocialMedia = () => {
    return (
      <div className='flex flex-row gap-4 my-2'>
        <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-[--primary] hover:text-[--warning-100]">
        ...
        <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-[--primary] hover:text-[--warning-100]">
        ...
        <a href="https://www.twitter.com/" target="_blank" rel="noopener noreferrer" className="text-[--primary] hover:text-[--warning-100]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="38" height="38">
